...
class JobController extends Controller
{
    public function index()
    {
        ...
        $jobs = Job::with(['type', 'salary', 'company', 'category', 'skills'])->get();
    ...
    public function create()
    {
        ...
        return view('admin.jobs.create', compact('categories', 'companies', 'salaries', 'skills', 'types'));
    }
    ...
    public function edit(Job $job)
    {
        ...
        $job->load('type', 'salary', 'company', 'category', 'skills');

        return view('admin.jobs.edit', compact('categories', 'companies', 'job', 'salaries', 'skills', 'types'));
    }
    ...
    public function show(Job $job)
    {
        ...
        $job->load('type', 'salary', 'company', 'category', 'skills', 'jobApplications');
