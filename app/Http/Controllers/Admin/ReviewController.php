...
class ReviewController extends Controller
{
    public function index()
    {
        ...
        $reviews = Review::with(['company', 'applicant'])->get();
    ...
    public function create()
    {
        ...
        return view('admin.reviews.create', compact('applicants', 'companies'));
    }
    ...
    public function edit(Review $review)
    {
        ...
        $review->load('company', 'applicant');

        return view('admin.reviews.edit', compact('applicants', 'companies', 'review'));
    }
