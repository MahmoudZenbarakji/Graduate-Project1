...
class CompanyController extends Controller
{
    ...
    public function index()
    {
        ...
        $companies = Company::with(['industries', 'user', 'media'])->get();
    ...
    public function create()
    {
        ...
        return view('admin.companies.create', compact('industries', 'users'));
    }
    ...
    public function edit(Company $company)
    {
        ...
        $company->load('industries', 'user');

        return view('admin.companies.edit', compact('company', 'industries', 'users'));
    }
    ...
    public function show(Company $company)
    {
        ...
        $company->load('industries', 'user', 'companyPayments', 'companyJobs', 'companyReviews');
