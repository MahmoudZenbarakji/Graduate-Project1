...
class EducationsApiController extends Controller
{
    public function index()
    {
        abort_if(Gate::denies('education_access'), Response::HTTP_FORBIDDEN, '403 Forbidden');

        return new EducationResource(Education::with(['applicant'])->get());
    }
    ...
    public function show(Education $education)
    {
        ...
        return new EducationResource($education->load(['applicant']));
    }
