          ...
          <div class="col-md-6 col-lg-3">
            <div class="widget-item widget-about">
              <div class="widget-logo-area">
                <a href="index.html">
                  <img class="logo-main" src="{{ asset('assets/img/logo-light-theme.png') }}" alt="Logo" />
                </a>
              </div>
              ...
              <div class="social-icons">
                ...
                <a href="https://www.skype.com" target="_blank" rel="noopener"><i class="icofont-whatsapp"></i></a>
                <a href="https://twitter.com" target="_blank" rel="noopener"><i class="icofont-instagram"></i></a>
              </div>
            </div>
          </div>
          <div class="col-lg-9">
                    ...
                    <div class="collapse-body">
                      <div class="widget-menu-wrap">
                        <ul class="nav-menu">
                          ...
                          <li><a href="{{ route('companies') }}">Our Partners</a></li>
                        </ul>
                      </div>
                    </div>
                  </div>
                    ...
                    <div class="collapse-body">
                      <div class="widget-menu-wrap">
                        <ul class="nav-menu">
                          ...
                          <li><a href="{{ route('jobs') }}">Job Packages</a></li>
        ...
        <div class="row">
          <div class="col-12">
            <div class="footer-bottom-content">
              <p class="copyright"> Made with <i class="icofont-heart"></i> by <a target="_blank" href="">ZMA Team.</a></p>
            </div>
          </div>
        </div>
      </div>
