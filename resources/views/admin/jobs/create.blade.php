    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.jobs.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('experiences_year') ? 'is-invalid' : '' }}" name="experiences_year" id="experiences_year" required>
                    ...
                    @foreach(App\Models\Job::EXPERIENCES_YEAR_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('experiences_year', '0') === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('working_hour') ? 'is-invalid' : '' }}" type="text" name="working_hour" id="working_hour" value="{{ old('working_hour', '') }}" required>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('responsibility') ? 'is-invalid' : '' }}" name="responsibility" id="responsibility">{{ old('responsibility') }}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('requirement') ? 'is-invalid' : '' }}" name="requirement" id="requirement">{{ old('requirement') }}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('benefits') ? 'is-invalid' : '' }}" name="benefits" id="benefits">{{ old('benefits') }}</textarea>
