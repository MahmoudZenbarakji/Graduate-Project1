    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="table-responsive">
                <table class=" table table-bordered table-striped table-hover datatable datatable-jobApplications">
                    <thead>
                        <tr>
                            <th width="10">
                            ...
                            <th>
                                {{ trans('cruds.application.fields.start_study') }}
                            </th>
                            <th>
...
@endcan
  ...
  let table = $('.datatable-jobApplications:not(.ajaxTable)').DataTable({ buttons: dtButtons })
