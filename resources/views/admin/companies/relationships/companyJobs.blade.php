    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="table-responsive">
                <table class=" table table-bordered table-striped table-hover datatable datatable-companyJobs">
                    <thead>
                        <tr>
                            <th width="10">
                            ...
                            <th>
                                {{ trans('cruds.job.fields.working_hour') }}
                            </th>
                            <th>
                            ...
                            <th>
                                {{ trans('cruds.job.fields.responsibility') }}
                            </th>
                            <th>
                                {{ trans('cruds.job.fields.requirement') }}
                            </th>
                            <th>
                                {{ trans('cruds.job.fields.benefits') }}
                            </th>
                            <th>
...
@endcan
  ...
  let table = $('.datatable-companyJobs:not(.ajaxTable)').DataTable({ buttons: dtButtons })
