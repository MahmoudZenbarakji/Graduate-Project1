    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="table-responsive">
                <table class=" table table-bordered table-striped table-hover datatable datatable-industriesCompanies">
                    <thead>
                        <tr>
                            <th width="10">
                            ...
                            <th>
                                {{ trans('cruds.company.fields.since') }}
                            </th>
                            <th>
...
@endcan
  ...
  let table = $('.datatable-industriesCompanies:not(.ajaxTable)').DataTable({ buttons: dtButtons })
